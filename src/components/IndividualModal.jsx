    ...
    <div className="truck-modal" onClick={props.onClose}>
      <div className="truck-modal-container" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="truck-data">
          ...
          <p>{truckData.Description != 'NULL' ? truckData.Description.toUpperCase() : ''}</p>

          <p>{truckData.Hours_of_Operation != 'NULL' ? truckData.Hours_of_Operation : ''}</p>
          <div>
            Cuisine tags:{' '}
          ...
          <div className="truck-modal-pics">
            <img
              src={truckData.P1 != 'NULL' ? truckData.P1 : '../Images/Truck-Avatar.png'}
              onError={(e) =>
            ...
            />
            <img
              src={truckData.P2 != 'NULL' ? truckData.P2 : '../Images/Truck-Avatar.png'}
              onError={(e) =>
                (e.target.onerror = null)(
                  (e.target.src =
            ...
            />
            <img
              src={truckData.P3 != 'NULL' ? truckData.P3 : '../Images/Truck-Avatar.png'}
              onError={(e) =>
                (e.target.onerror = null)(
                  (e.target.src =
          ...
          <div onClick={() => alert('MAYBE A SICK ASS PING OF THE VENDOR')}>WHERE AM I???</div>
        </div>
      </div>
    </div>
  );
